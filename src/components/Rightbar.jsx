import { Avatar,List, AvatarGroup, Box, Divider, ImageList, ImageListItem, ListItem, ListItemText, Typography } from '@mui/material'
  ...
  return (
    <Box padding={2}
      ...
      <Box position="fixed"  width={300}>
        ...
        <Typography marginTop={2} variant="h5" fontWeight={100}>Latest Photo</Typography>
        <ImageList sx={{ marginTop: 2, marginBottom: 2 }} cols={3} rowHeight={100} gap={5} >
          <ImageListItem>
            <img
        ...
        <Typography marginTop={2} variant="h5" fontWeight={100}>Latest </Typography>
